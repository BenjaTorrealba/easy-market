...
{#if autorizado}
  ...
  <div class="p-6 space-y-10">
    <div>
      <h2
        class="text-2xl font-bold mb-4 text-yellow-800 flex items-center gap-2"
      >
        <svg
          ...
          <tbody>
            {#each productosBajoStock as producto}
              <tr class="hover:bg-yellow-100/40 transition">
                <td class="border-t px-6 py-3 font-semibold"
                  >{producto.nombre}</td
                >
    ...
    <div>
      ...
      <div class="overflow-x-auto">
        <table
          class="min-w-full rounded-lg shadow border border-blue-200 bg-blue-50"
        >
          <thead>
            <tr>
              <th
                class="px-6 py-3 text-left bg-blue-100 text-blue-700 font-semibold"
                >Fecha pedido</th
              >
              <th
                class="px-6 py-3 text-left bg-blue-100 text-blue-700 font-semibold"
          ...
          <tbody>
              ...
              <tr class="hover:bg-blue-100/40 transition">
                ...
                <td class="border-t px-6 py-3">
                  <div class="flex gap-2 items-center">
                    {#if pedido.estado === "Pendiente" && (rol === "admin" || rol === "vendedor")}
                      <button
            ...
            {#if pedidos.length === 0}
              <tr>
                <td colspan="6" class="text-gray-400 px-6 py-3"
    ...
    <div>
      <h2
        class="text-2xl font-bold text-green-700 flex items-center gap-2 mb-4"
      >
        <svg
      ...
      <div class="overflow-x-auto">
        <table
          class="min-w-full rounded-lg shadow border border-green-200 bg-white"
        >
          <thead>
            <tr>
              <th
          ...
          <tbody>
            ...
            {#if pedidosConfirmados.length === 0}
              <tr>
                <td colspan="5" class="text-gray-400 px-6 py-3"
                  >No hay pedidos confirmados.</td
                >
              </tr>
            {/if}
          </tbody>
